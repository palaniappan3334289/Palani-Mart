...
<c:set var="pageTitle" value="Orders & Fulfillment — Seller Hub" scope="request" />
...
<div class="container" style="padding-top: var(--space-6); padding-bottom: var(--space-12);">
    ...
    <div style="margin-bottom: var(--space-8);">
        <h1 style="font-size: 2.25rem; margin-bottom: var(--space-1);">Fulfillment Orders</h1>
        <p style="color: var(--text-muted); font-size: 0.9375rem; margin: 0;">Review orders containing your listings and update shipping dispatch statuses</p>
    </div>
    ...
    <c:if test="${param.updated == 'true'}">
        <div class="alert alert-success" style="background-color: var(--success-bg); color: var(--success-text); border: 1px solid var(--success-border); padding: var(--space-4); border-radius: var(--radius-sm); margin-bottom: var(--space-6);">
            <strong>&#10003; Status Updated!</strong> Order dispatch status has been updated.
        </div>
    </c:if>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <div class="empty-state">
                    ...
                    <h3 class="empty-state-title">No Orders Assigned</h3>
                    <p class="empty-state-desc">Buyer orders containing your creations will appear here for fulfillment.</p>
                </div>
            </c:otherwise>
        </c:choose>
    </div>
